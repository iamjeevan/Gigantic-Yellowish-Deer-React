        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text26">#home</span>
                </Fragment>
              )}
            </a>
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text27">#services</span>
                </Fragment>
              )}
            </a>
            <div
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text17">About Us</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  page1ImageAlt: 'image',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1533497374533-d860dceecf74?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMDMyMDAyN3w&ixlib=rb-4.0.3&q=80&w=1080',
  action1: undefined,
  ...
  page4ImageSrc:
    'https://images.unsplash.com/photo-1522071820081-009f0129c71c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMDMyMDAyNnw&ixlib=rb-4.0.3&q=80&w=1080',
  link2Url: 'https://www.teleporthq.io',
  linkUrlPage1: 'https://www.teleporthq.io',
  linkUrlPage3: 'https://www.teleporthq.io',
  logoAlt: 'RecruitBot Logo',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1619853547224-55040086ac2b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMDMyMDAyN3w&ixlib=rb-4.0.3&q=80&w=1080',
  link2: undefined,
  page1: undefined,
  link1: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1620553967922-f3ca60bbc1ea?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMDMyMDAyNnw&ixlib=rb-4.0.3&q=80&w=1080',
  link3: undefined,
}
