                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text30">
                      ...
                      powerful features for transforming your recruitment
                      process.
                    </span>
                  </Fragment>
                )}
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text27">
                      Customize your candidate requirements, job descriptions,
                      and other preferences to ensure RecruitBot finds the best
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text32">
                      ...
                      recruitment practices to enhance your team&apos;s skills
                      in compliance, interviewing, and diversity.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Utilize RecruitBot&apos;s data insights and predictive
                      analytics to streamline every stage of recruitment,
                      leading to quality hires and improved efficiency.
                    </span>
                  </Fragment>
                )}
              </span>
